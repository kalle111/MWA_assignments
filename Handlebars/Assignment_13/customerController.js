...
module.exports = 
{
    ...
    checkLoginData: function(inputuser, inputpassword) 
    {
      return new Promise((resolve, reject) => {

        console.log("User: ", inputuser, ", Password: ", inputpassword);
        let sqlQuery = `SELECT * from user WHERE userName = "${inputuser}" AND userPassword= "${inputpassword}";`;
